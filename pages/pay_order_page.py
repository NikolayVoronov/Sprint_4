...
class WhoOrderPage:
    ...
    """" Вставить значение в поле номер телефона """
    ...
    """ Заполнить все поля с данными и нажать далее"""
